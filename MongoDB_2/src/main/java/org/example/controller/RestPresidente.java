...
public class RestPresidente {
    ...
    public ResponseEntity<Void> criarPresidente(@RequestBody Presidente presidente) {
        presidenteService.criarPresidente(presidente);
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Presidente> modificarPresidente(@PathVariable String id, @RequestBody Presidente presidenteActualizado) {
        Presidente presidenteModificado = presidenteService.modificarPresidente(id, presidenteActualizado);
